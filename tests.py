...
class CrudTestCase(FlaskTestCase):
    # USER ########################################
    ...
    def test_add_member(self):
        ...
        insert_status = db.create_member({
        ...
        self.assertEqual(insert_status['rowcount'], 1)
        member_id = insert_status['id']
        test_hg = db.find_member(member_id)
        self.assertIsNotNone(test_hg)

        self.assertEqual(test_hg['first_name'], 'New')
        self.assertEqual(test_hg['last_name'], 'Member')
        self.assertEqual(test_hg['email'], 'newmember@example.com')
        self.assertEqual(test_hg['phone_number'], '555-1212')
        self.assertEqual(test_hg['gender'], 'F')
        self.assertEqual(test_hg['birthday'], '2001-12-25')
        self.assertEqual(test_hg['baptism_status'], True)
        self.assertEqual(test_hg['marital_status_id'], marital['id'])
        self.assertEqual(test_hg['how_did_you_find_out_id'], how['id'])
        self.assertEqual(test_hg['join_date'], '2018-03-24')
