...
INSERT INTO public.member ( first_name, last_name, email, phone_number, gender, birthday, baptism_status, marital_status_id,
 how_did_you_find_out_id, is_a_parent, join_date, is_active) VALUES ( 'Gustavo', 'A', 'example1@example.com', '555555555', 'M', '2003-03-21', true, 1, 3, false, '2018-03-25', true);
INSERT INTO public.member ( first_name, last_name, email, phone_number, gender, birthday, baptism_status, marital_status_id,
 how_did_you_find_out_id, is_a_parent, join_date, is_active) VALUES ( 'Alejandra', 'Zambrano', 'Alejandra@gmail.com', '3323049293', 'F', '1995-02-08', true, 2, 3, false, '2018-03-25', true);
INSERT INTO public.member ( first_name, last_name, email, phone_number, gender, birthday, baptism_status, marital_status_id,
 how_did_you_find_out_id, is_a_parent, join_date, is_active) VALUES ( 'Mendoza', 'Alfredo', 'mendoza@example.com', '5555555555', 'M', '1981-03-15', false, 1, 1, true, '2018-03-25', true);
INSERT INTO public.member ( first_name, last_name, email, phone_number, gender, birthday, baptism_status, marital_status_id,
 how_did_you_find_out_id, is_a_parent, join_date, is_active) VALUES ( 'Garcia', 'Princeton', 'garcia@example.com', '7779998888', 'F', '1982-03-02', true, 2, 2, false, '2018-03-25', true);
INSERT INTO public.member ( first_name, last_name, email, phone_number, gender, birthday, baptism_status, marital_status_id,
 how_did_you_find_out_id, is_a_parent, join_date, is_active) VALUES ( 'Pilar', 'Roberto', 'pilar@example.com', '8192929300', 'F', '1983-03-22', false, 4, 1, true, '2018-03-25', true);
INSERT INTO public.member ( first_name, last_name, email, phone_number, gender, birthday, baptism_status, marital_status_id,
 how_did_you_find_out_id, is_a_parent, join_date, is_active) VALUES ( 'Xavier', 'Guillermo', 'xavier@example.com', '9102990999', 'M', '2000-03-21', true, 5, 1, true, '2018-03-25', true);
INSERT INTO public.member ( first_name, last_name, email, phone_number, gender, birthday, baptism_status, marital_status_id,
 how_did_you_find_out_id, is_a_parent, join_date, is_active) VALUES ( 'Diego', 'Estaban', 'diego@example.com', '7478182999', 'M', '1993-03-06', false, 1, 2, true, '2018-03-25', true);
INSERT INTO public.member ( first_name, last_name, email, phone_number, gender, birthday, baptism_status, marital_status_id,
 how_did_you_find_out_id, is_a_parent, join_date, is_active) VALUES ( 'Elena', 'Danilo', 'elena@example.com', '81992039929', 'F', '2005-03-13', true, 1, 3, false, '2018-03-25', true);
INSERT INTO public.member ( first_name, last_name, email, phone_number, gender, birthday, baptism_status, marital_status_id,
 how_did_you_find_out_id, is_a_parent, join_date, is_active) VALUES ('Pepe', 'A', 'example2@example.com', '7182990000', 'M', '1995-03-16', true, 4, 3, true, '2018-03-25', true);
INSERT INTO public.member ( first_name, last_name, email, phone_number, gender, birthday, baptism_status, marital_status_id,
 how_did_you_find_out_id, is_a_parent, join_date, is_active) VALUES ( 'Fernando', 'A', 'example3@example.com', '8829882000', 'M', '1996-03-11', true, 1, 2, true, '2018-03-25', true);
INSERT INTO public.member ( first_name, last_name, email, phone_number, gender, birthday, baptism_status, marital_status_id,
 how_did_you_find_out_id, is_a_parent, join_date, is_active) VALUES ( 'Ishmael', 'A', 'example4@example.com', '82900039439', 'M', '1997-03-15', true, 4, 1, true, '2018-03-25', true);
INSERT INTO public.member ( first_name, last_name, email, phone_number, gender, birthday, baptism_status, marital_status_id,
 how_did_you_find_out_id, is_a_parent, join_date, is_active) VALUES ( 'Ivanova', 'A', 'example5@example.com', '8289993000', 'M', '1998-03-14', true, 1, 3, false, '2018-03-25', true);
...
INSERT INTO public.member_role (member_id, password, role_id, is_active) VALUES (10, '$2b$12$QKxOfwupJyXuRopVFZdFVOasanhZRj0nhuwcoBWEClm9YnM6nG5Qq', 1, true);
INSERT INTO public.member_role (member_id, password, role_id, is_active) VALUES (14, '$2b$12$FnTGF6vw669Caq3mpNKbpu9jSVpuQJpqtL/PqQSzR1qMBYxcto8.W', 1, true);
INSERT INTO public.member_role (member_id, password, role_id, is_active) VALUES (3, '$2b$12$JrD7JZ.8cJDa/orbP4CGwORolalghHztPL9p22/kCLvMYTgOa.q3m', 1, true);
