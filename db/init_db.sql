...
INSERT INTO member(email, first_name, last_name,  phone_number, gender, birthday, baptism_status, marital_status, join_date, is_active ) values ('nysha@example.com', 'Nysha', 'Chen', '1112223333', 'F', '1990-05-02', 1, 0, '2016-08-01', 1 );
...
INSERT INTO member(email, first_name, last_name,  phone_number, gender, birthday, baptism_status, marital_status, join_date, is_active ) values ('ellen@example.com', 'Ellen', 'Sokolowski', '5551353245', 'F', '1994-09-16', 1, 0, '2016-08-01', 1 );
INSERT INTO member(email, first_name, last_name,  phone_number, gender, birthday, baptism_status, marital_status, join_date, is_active ) values ('krista@example.com', 'Krista', 'Hapner', '5551353245', 'F', '2000-01-01', 1, 1, '2016-08-01', 1 );
