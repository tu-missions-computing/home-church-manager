...
INSERT INTO member(email, first_name, last_name,  phone_number, gender, birthday, baptism_status, marital_status, join_date, is_active ) values ('admin@example.com', 'Joel', 'Guido', '02-398423', 'M', '1980-05-02', '1', '1', '2016-08-01', '1' );
...
INSERT INTO homegroup(name, location, description, latitude, longitude, is_active) values ('Singles Group', 'Avenida Loja, Cuenca, Ecuador', 'Growing together and discovering our purpose as single individuals.',-2.9055067,-79.0273297, '1');
--
